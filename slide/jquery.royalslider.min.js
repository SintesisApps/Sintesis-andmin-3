...
!0;this._a3=this._l2=!1;this._y2()},_y2:function(b,f){function c(a){return 1000>a?1000:500<a?500:a}function h(b,d){if(a._l||f)g=(-a._u-a._d1)*a._w,j=Math.abs(a._p-g),a._c=j/d,b&&(a._c+=250),a._c=c(a._c),a._x3(g,!1)}var a=this,e,d,g,j;d="touchend"===b.type||"touchcancel"===b.type;if(!a._s2||d)if(a._s2=!1,a.ev.trigger("rsDragRelease"),a._u3=null,a._l2=!1,a._r3=!1,a._l3=!1,a._m3=0,cancelAnimationFrame(a._t3),a._a3&&(f?a._q3(a._h3):a._l&&a._p3(a._h3)),a._b.off(a._k1).off(a._l1),d&&a._e1.off(a._m1),a._i1(),
...
height:"1000%"}),c="rsMainSlideImage"));f.hasClass(c)||(f=f.find("."+c));if(f){var g=b.iW,c=b.iH;b.isRendered=!0;if("none"!==e||a){bMargin="fill"!==e?this._d4:0;b=this._b4-2*bMargin;d=this._c4-2*bMargin;var j,k,l={};if("fit-if-smaller"===e&&(g>b||c>d))e="fit";if("fill"===e||"fit"===e)j=b/g,k=d/c,j="fill"==e?j>k?j:k:"fit"==e?j<k?j:k:1,g=Math.ceil(g*j,10),c=Math.ceil(c*j,10);"none"!==e&&(l.width=g,l.height=c,h&&f.find(".rsImg").css({width:"1000%",height:"1000%"}));a&&(l.marginLeft=Math.floor((b-g)/2)+
